...
announce.c
BONSRC = ./bonus/so_long_bonus.c ./bonus/get_next_line.c ./bonus/get_next_line_utils.c ./bonus/parsing_checking_map_bonus.c ./bonus/utils_bonus.c ./bonus/graphics_bonus.c \
